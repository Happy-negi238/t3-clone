...
export async function POST(req: NextRequest) {
  try {
    ...
    // Clean up: result.consumeStream() is no longer needed here.
    // Wrap the core stream using stateless utility functions.
    ...
    // Pass the formatted stream directly into the response helper
